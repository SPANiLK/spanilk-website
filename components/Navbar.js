  ...
  return (
    <nav className="bg-matteBlack sticky top-0 z-50">
      <Head>
        ...
        <meta
          name="description"
          content="SPANiLK - A software development company"
        />
          ...
          <div className="px-2 md:px-0 md:flex flex items-center">
            <button>
              <Link href="/contact">
                <a
                  href=""
                  className="py-3 px-5 bg-primary text-gray-900 font-medium rounded hover:bg-primaryDark hover:text-gray-100 transition duration-300"
                >
                  Let&apos;s Talk
                </a>
              </Link>
      ...
      <div className="md:hidden">
        <nav className="fixed bottom-0 inset-x-0 bg-primary flex justify-between text-sm text-gray-700 py-0">
          <Link href="/">
            <a
              className={`${
                router.pathname == "/" ? "bg-matteBlack text-gray-100" : ""
              } w-full block py-2 px-3 text-center hover:bg-matteBlack hover:text-gray-100`}
            >
